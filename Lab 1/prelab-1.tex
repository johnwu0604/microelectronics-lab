...
\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Screenshots/Circuit_215.png}
\caption{\label{fig:current-circuit} Circuit used for analyzing current source.}
\end{figure}

\begin{figure}[H]
\centering
\includegraphics[width=0.8\textwidth]{Screenshots/Graph_215.png}
...
The max DC offset that results in the maximum output voltage swing occurs at the centre of the steepest part of the curve. This offset value is around 2V.
